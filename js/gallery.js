    ...
    const collections = [
        ...
        },
       {
            ...
            images: [
                ...
                { src: 'assets/images/o.png', alt: '2026' },
                { src: 'assets/images/p.png', alt: '2026' },
                { src: 'assets/images/q.png', alt: 'Santa Fe Beach Club' },
                { src: 'assets/images/r.png', alt: 'Mangrove Eco Park' },
                { src: 'assets/images/s.png', alt: 'Fammy' },
                { src: 'assets/images/t.png', alt: 'Safari Park' },
                { src: 'assets/images/u.png', alt: '2025' },
                { src: 'assets/images/v.png', alt: '2024' },
                { src: 'assets/images/w.png', alt: '18th Birthday' },
                { src: 'assets/images/x.png', alt: 'Ocean Park' },
                { src: 'assets/images/y.png', alt: 'Samgyeopsal' },
                { src: 'assets/images/z.png', alt: 'Fantastic Island' },
                { src: 'assets/images/1a.png', alt: 'Bogo City' },
                { src: 'assets/images/1b.png', alt: 'Balay Kahayag' },
                { src: 'assets/images/1c.png', alt: 'Santa Fe Beach Club' },
                { src: 'assets/images/1d.png', alt: 'Mangrove Eco Park' },
                { src: 'assets/images/1e.png', alt: 'Fammy' },
                { src: 'assets/images/1f.png', alt: 'Safari Park' },
            ],
        },
      {
            title: 'Coming Soon',
